...
$(addprefix $(TARGET_PATH)/, $(SONIC_INSTALLERS)) : $(TARGET_PATH)/% : \
        ...
        $(addprefix $(PYTHON_WHEELS_PATH)/,$(SONIC_MOBILE_MANAGEMENT_PY3)) \
	...
	export sonic_mobile_management_py3_wheel_path="$(addprefix $(PYTHON_WHEELS_PATH)/,$(SONIC_MOBILE_MANAGEMENT_PY3))"
